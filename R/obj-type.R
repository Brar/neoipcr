...
is_neoipcr_dhis2_mdopt <- function(x) inherits(x, "neoipcr_dhis2_mdopt")
is_scalar_neoipcr_dhis2_mdopt <- function(x) inherits(x, "neoipcr_dhis2_mdopt") && rlang::is_scalar_list(x)
